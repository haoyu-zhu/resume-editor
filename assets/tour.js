...
(function () {
  ...
  const STEPS = [
    ...
    { title: "也可以给划选的字上色",
      body: "选中纸上的字，点一个色块就上色，最后那个 <b>✕</b> 去掉颜色。五个颜色和下面「主题色」是同一组，但<b>不跟着主题变</b>——标成酒红的字，换成绿色主题之后还是酒红。<br>省着用：整页花花绿绿反而让重点消失，而且黑白打印机上全都是灰的。",
      sel: "#text-colors", place: "right" },
    ...
    { title: "行右边的几个按钮",
      body: "鼠标移到某一行上，右边会冒出 <b>⠿ 🔗 ¶ ✕</b>：拖着 ⠿ 排序、🔗 改链接、✕ 删掉这一行。光标放进某行按 <kbd>Alt</kbd>+<kbd>↑↓</kbd> 也能挪。<br>按钮在<b>光标点进这一行之后会钉住不动</b>，可以慢慢移过去点，不用一路悬停着找。",
      sel: "#doc .bullet .ctl", reveal: "#doc .bullet", place: "left" },

    { title: "¶ ：把一条要点写成一段概述",
      body: "点要点右边的 <b>¶</b>，前面那个<b>蓝方块和悬挂缩进一起去掉</b>，整条变成一段平铺的话，左边和条目标题齐平。<br>用在一段经历的开头：先用两句话交代这是个什么项目、你负责哪一块，下面再用要点摆成果。去掉之后左边会出现 <b>＋方块</b>，点它变回普通要点。",
      sel: "#doc .bullet .ctl-plain", reveal: "#doc .bullet", place: "left" },
